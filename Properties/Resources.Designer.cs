...
namespace MinorShift.Emuera.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   {0}関数:画像の範囲外が指定されています과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:ColorARGB引数に不適切な値(0x{1:X8})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:第{2}引数に不適切な値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:ColorMatrixの指定された要素({1}, {2})が不適切であるか5x5に足りていません과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:描画オプションがWINAPIの時には使用できません과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsのHeightに0以下の値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsのHeightに{2}以上の値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsIDに負の値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsIDの値({1})が大きすぎます과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsのWidthに0以下の値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:GraphicsのWidthに{2}以上の値({1})が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:第{1}引数は省略できません과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:引数の数が間違っています과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:少なくとも{1}個の引数が必要です과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:引数の数が多すぎます과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:第{1}引数の型が間違っています과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0}関数:ColorMatrixに5x5以上の二次元数値型配列変数でない引数が指定されました과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
